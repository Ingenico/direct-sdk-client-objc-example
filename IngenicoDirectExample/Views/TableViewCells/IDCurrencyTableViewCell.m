...
@interface IDCurrencyTableViewCell ()

@property (strong, nonatomic) UILabel *separatorlabel;
@property (strong, nonatomic) UILabel *currencyCodeLabel;
@property (strong, nonatomic) IDIntegerTextField *integerTextField;
@property (strong, nonatomic) IDFractionalTextField *fractionalTextField;

@end

@implementation IDCurrencyTableViewCell
