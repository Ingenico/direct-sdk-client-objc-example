...
@interface IDReadonlyReviewTableViewCell()
...
@implementation IDReadonlyReviewTableViewCell
...
- (void)updateLabel {
    NSAttributedString *combiString = [IDReadonlyReviewTableViewCell labelAttributedStringForData:self.data inWidth:self.frame.size.width];
...
+ (NSAttributedString *)labelAttributedStringForData:(NSDictionary<NSString *, NSString *> *)data inWidth:(CGFloat)width {
    ...
    NSString *successString = NSLocalizedStringWithDefaultValue(successStringKey, kIDSDKLocalizable,
                                                            [NSBundle bundleWithPath:kIDSDKBundlePath],
                                                            successStringKey, @"");
