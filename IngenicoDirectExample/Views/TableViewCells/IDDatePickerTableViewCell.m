...
@interface IDDatePickerTableViewCell ()

@property (nonatomic, strong) UIDatePicker *datePicker;

@end

@implementation IDDatePickerTableViewCell
...
- (void)layoutSubviews {
    ...
    if (self.datePicker != nil) {
        ...
        CGRect frame = CGRectMake(10, 0, width - 20, [IDDatePickerTableViewCell pickerHeight]);
