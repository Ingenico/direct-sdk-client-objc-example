...
@interface IDTextFieldTableViewCell ()

@property (strong, nonatomic) IDTextField *textField;
@property (strong, nonatomic) IDLabel *errorLabel;

@end

@implementation IDTextFieldTableViewCell
...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    if (self) {
        self.textField = [[IDTextField alloc]init];
        self.clipsToBounds = YES;
        [self addSubview:self.textField];
        
        self.errorLabel = [[IDLabel alloc]init];
...
- (void)setField:(IDFormRowField *)field {
    _field = field;
    if (field != nil) {
