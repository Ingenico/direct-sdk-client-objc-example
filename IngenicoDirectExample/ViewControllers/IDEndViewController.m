...
@implementation IDEndViewController
...
- (void)viewDidLoad {
    ...
    label.text = NSLocalizedStringFromTable(@"SuccessLabel", kIDAppLocalizable, nil);
    label.translatesAutoresizingMaskIntoConstraints = NO;
    
    UITextView *textView = [[UITextView alloc] init];
    [container addSubview:textView];
    textView.textAlignment = NSTextAlignmentCenter;
    textView.text = NSLocalizedStringFromTable(@"SuccessText", kIDAppLocalizable, nil);
    ...
    UIButton *button = [self.viewFactory buttonWithType:IDButtonTypePrimary];
    [container addSubview:button];
    NSString *continueButtonTitle = NSLocalizedStringFromTable(@"ContinueButtonTitle", kIDAppLocalizable, nil);
